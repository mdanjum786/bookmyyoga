...
@media (max-width: 600px) {
  .filter-bar { padding: 16px 6px 10px 6px; }
  .filter-bar .search-row, .filter-bar .filter-controls { flex-direction: column; align-items: stretch; gap: 10px; }
  .filter-bar .form-control, .filter-bar select { width: 100% !important; min-width: 0; max-width: 100%; }
}
</style>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="wrapper">
                    ...
                    <header class="filter__section bg-light p-0">
                       <form class="form-filter" id="form-filter" method="get">
                        <div class="filter-bar">
                          <div class="search-row">
                            <input type="text" class="form-control br_25" name="q" placeholder="Search by name, city, region, pincode, state..." value="<?= isset($q) ? esc($q) : '' ?>">
                            <button type="submit" class="btn btn-search">Search</button>
                          </div>
                          <div class="filter-controls">
                            <div class="filter_sort">
                              <label for="products-orderby">Sort</label>
                              <select class="form-control course-sort select br_25 d-inline-block w-auto" id="products-orderby" name="sort">
                            ...
                            <div class="filter_sort">
                              <label for="page-limit">Display</label>
                              <select class="form-control select br_25 page-limit d-inline-block w-auto" id="page-limit" name="limit" style="width:100px">
