        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2">Yoga Retreat</h1>
                    <nav class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=base_url('/'); ?>">home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Yoga Retreat</li>
                        </ol>
                    </nav>
                </div>
                <!-- Page Header Box End -->
                    ...
                    <section class="products row list group">
                      ...
                      ?>
                        ...
                        <article class="product col-md-3">
                            <h3>No Found Yoga Retreat Data </h3>
                        </article>
                        <?php
                        }
                        ?>
...
<script>
  $(function(){
    $(document).on('click', '.btn-enquiry', function(e){
        ...
        enquiry_modal.find('.modal-title').text('Yoga Retreat Enquiry');
