        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2">Event</h1>
                        ...
                        <article class="product col-md-3 course-list-item" data-id="<?= $course['id'] ?>">
                            <div class="product__inner">
                                ...
                                <div class="product__details">
                                   ...
                                   <div class="d-flex gap-3 align-items-center no-wrap justify-content-between">
                                    <div class="e_btn gap-3 d-flex">
                                                                            <?php
                                    ...
                                    <div class=" da_t_e ">
                                        <?php
                                            if(null !== $course['startdate']  && null !== $course['enddate']){


                                        ?>
                                         <span class=""><b style="color:; font-size: 14px"> From  <?= date('d/n/Y', $course['startdate'])?>  </b> to  <b style="color:# ; font-size: 14px"><?= date('d/n/Y', $course['enddate'])?></b></span>
                                     <?php } ?>
                                    </div>
                                   </div>
                                    ...
                                    <section class="product__short_description">
                                     ...
                                     <div class="btn_book">
                                        <a href="tel:88102-69302" class="btn_bokt  "><img
                                                src="<?= base_url(); ?>assets/front/images/icon-phone.svg">
                                            +91-88102-69302</a>
                                        <a href="https://api.whatsapp.com/send?phone=918810269302&text=Hello,%20%0A%20I%20have%20a%20question%20about%20https%3A%2F%2Fwww.bookmyyoga.in%2Fservices" class=" btn_w  "><i
                                                class="fa-brands fa-whatsapp"></i> WhatsApp</a>
                                        <a href="https://www.bookmyyoga.in/contact-us" class=" btn_email btn-enquiry  "><i
...
<script>
  $(function(){
    $(document).on('click', '.btn-enquiry', function(e){
        ...
        enquiry_modal.find('.modal-title').text('Event Enquiry');
