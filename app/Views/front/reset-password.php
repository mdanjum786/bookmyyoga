      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="page-header-box">
            <h1 class="text-anime-style-2" data-cursor="-opaque">Reset Password</h1>
        ...
        <div class="form-container">
            ...
            <form id="login-form" >
                ...
                <div class="mb-3 error-parent">
                    ...
                    <input type="password" class="form-control" id="confirm_password" name="crm_password" 
                ...
                <button type="submit" class="btn  w-100" id="submitBtn" style="background: #619e90;
    color:#fff">
                    Reset
                    <span class="loading">
