        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2">Corporate Yoga</h1>
                    <nav class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=base_url('/'); ?>">home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Corporate Yoga</li>
                        </ol>
                    </nav>
                </div>
                <!-- Page Header Box End -->
                    ...
                    <section class="products row list group">
                      ...
                      ?>
                            ...
                            <div class="product__inner">
                                ...
                                <div class="product__details">
                                   ...
                                   <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <?php } ?>
                                   <a href="javascript:void(0);" class=" btn__book btn-enquiry  " style=""><i
                                                class="fa fa-shopping-bag  "></i>  Book Now</a>
                                   </div>
                        ...
                        <article class="product col-md-3">
                            <h3>No Corporate Yoga data Found</h3>
                        </article>
                        <?php
                        }
                        ?>
...
<script>
  $(function(){
    $(document).on('click', '.btn-enquiry', function(e){
        ...
        enquiry_modal.find('.modal-title').text('Corporate Yoga Enquiry');
