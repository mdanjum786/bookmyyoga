        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2">Courses</h1>
                                ...
                                <div class="product__details">
                                   ...
                                   <!--  <a href="javascript:void(0);" class=" btn_email  "><i
                                    ...
                                    <section class="product__short_description">
                                        <a href="<?= base_url('detail/') . $course['slug']; ?>">
                                         <span class="text-dark c_discription"> <?= strip_tags($course['short_description']) ?? ''  ;?></span>
                                        </a>
                                    </section>
...
<script>
  $(function(){
    $(document).on('click', '.btn-enquiry', function(e){
        ...
        enquiry_modal.find('.modal-title').text('Course Enquiry');
